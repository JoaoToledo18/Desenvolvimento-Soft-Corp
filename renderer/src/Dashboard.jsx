...
import Usuarios from "./components/Usuarios"; // Import do componente de funcionários
  ...
  return (
    <div className="flex flex-col min-h-screen transition-colors duration-300">
      ...
      <main className="flex-1 p-6">
        {mostrarDashboard ? (
          <>
            <h2 className="text-2xl font-bold mb-4 text-center">Dashboard Principal</h2>

            <div
              className={`w-full min-h-[300px] border-2 rounded-lg p-4 shadow-md transition-colors duration-300 ${
                temaEscuro ? "border-yellow-600 bg-[#3b240f]" : "border-red-400 bg-yellow-50"
              }`}
            >
              ...
              {carregandoVendas ? (
                ...
                <GraficoBarra labels={labels} valores={valores} titulo="Top Vendas" nomeDataset="Quantidade Vendida" />
              ) : (
          ...
          <>
            ...
            {selecionado === "Funcionários" && <Usuarios temaEscuro={temaEscuro} />}
            ...
            {!["Produtos", "Funcionários"].includes(selecionado) && (
              <div
                className={`w-full min-h-[400px] flex items-center justify-center rounded-lg border-2 p-6 text-xl font-semibold transition-colors duration-300 ${
                  temaEscuro ? "border-yellow-600 bg-[#3b240f] text-yellow-200" : "border-red-400 bg-yellow-50 text-red-700"
                }`}
              >
